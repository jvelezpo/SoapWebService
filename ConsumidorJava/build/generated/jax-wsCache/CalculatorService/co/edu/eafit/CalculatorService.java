 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://eafit.edu.co/", wsdlLocation = "http://sebastian-pc:8080/WebApplication1/CalculatorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://eafit.edu.co/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://sebastian-pc:8080/WebApplication1/CalculatorService?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://eafit.edu.co/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://eafit.edu.co/", "CalculatorPort"), Calculator.class, features);
    }
